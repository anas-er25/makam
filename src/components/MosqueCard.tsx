...
const MosqueCard = ({ id, name, image, location, description }: MosqueCardProps) => {
  return (
        ...
        <div className="mt-4 space-x-4">
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="outline">نظرة سريعة</Button>
            </DialogTrigger>
          ...
          <Link to={`/mosque/${id}`}>
            <Button className="button-primary">عرض التفاصيل</Button>
          </Link>
        </div>
      </div>
    </div>
